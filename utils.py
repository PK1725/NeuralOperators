...
def generate_test_tensor(n_simulations,test_resolutions,device,L,n,t_max,dt,nu,old_ic=False,solver='Fourier'):
    # Test data
    ...
    for res in test_resolutions:
        ...
        x_grid_test,u_t_test, u_0_test = simulate_IC(n_simulations,initial_conditions,L, n, t_max, dt, nu,
                                                    ...
                                                    space_res=res[0],time_res=res[1],old_ic=old_ic,solver=solver)
